...
public class AboutActivity extends BaseActivity<ActivityAboutBinding> {
    ...
    public void onFeedbackLog(View view) {
        if (isWindowLocked())
            return;
        File trackerLog = new File(RemoteMainWithMetering20DActivity.PATH_LOGCAT + File.separator + "MKRemoteGW20D.txt");
        File trackerLogBak = new File(RemoteMainWithMetering20DActivity.PATH_LOGCAT + File.separator + "MKRemoteGW20D.txt.bak");
        File trackerCrashLog = new File(RemoteMainWithMetering20DActivity.PATH_LOGCAT + File.separator + "crash_log.txt");
