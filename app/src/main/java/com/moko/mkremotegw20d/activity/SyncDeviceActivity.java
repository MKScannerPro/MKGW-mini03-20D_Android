...
import com.moko.mkremotegw20d.adapter.SyncDeviceAdapter;
import com.moko.mkremotegw20d.base.BaseActivity;
import com.moko.mkremotegw20d.databinding.ActivityDevicesBinding;
import com.moko.mkremotegw20d.db.DBTools20D;
import com.moko.mkremotegw20d.dialog.LogoutDialog;
...
import com.moko.mkremotegw20d.net.entity.SyncDevice;
...
public class SyncDeviceActivity extends BaseActivity<ActivityDevicesBinding> implements BaseQuickAdapter.OnItemClickListener {
    ...
    private void syncDevices(List<SyncDevice> syncDevices) {
        ...
        OkGo.<String>post(Urls.syncGatewayApi(getApplicationContext()))
                .upRequestBody(body)
                .headers("Authorization", RemoteMain20DActivity.mAccessToken)
