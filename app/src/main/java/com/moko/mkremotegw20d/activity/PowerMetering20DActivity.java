...
import com.moko.mkremotegw20d.databinding.ActivityPowerMetering20dBinding;
 ...
 * @des:
 */
public class PowerMetering20DActivity extends BaseActivity<ActivityPowerMetering20dBinding> {
    ...
    @Override
    protected ActivityPowerMetering20dBinding getViewBinding() {
        return ActivityPowerMetering20dBinding.inflate(getLayoutInflater());
    }
    ...
    protected void onCreate() {
        ...
        mBind.layoutMeteringSwitch.setOnClickListener(v -> {
            ...
            Intent i = new Intent(this, MeteringSettings20DActivity.class);
