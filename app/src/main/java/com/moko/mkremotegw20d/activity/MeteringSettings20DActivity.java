...
import com.moko.mkremotegw20d.databinding.ActivityMeteringSettings20dBinding;
 ...
 * @des:
 */
public class MeteringSettings20DActivity extends BaseActivity<ActivityMeteringSettings20dBinding> {
    ...
    @Override
    protected ActivityMeteringSettings20dBinding getViewBinding() {
        return ActivityMeteringSettings20dBinding.inflate(getLayoutInflater());
    }
